...
%NOTE: power intensity ratio will be messed up since not modified in
%normalization-so any functions involving that or max_intensity will be
%wrong!!!
...
max_fluence = max(max(pump_beam.fluence_matrix))* 1/(pump_beam.pixel_size^2); %divide by pixel size to get mJ/um^2, currently fluence matrix using mJ/pixelsize^2
...
figure
%subtracting pixel_size/2 to plot points at center of pixel
