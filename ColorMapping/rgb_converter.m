...
while isempty(row_index)
    r_indices = intersect(find((rgb_scale(:,1,1) - rgb(1)) <= i), find((rgb_scale(:,1,1) - rgb(1)) >= i));
    g_indices = intersect(find((rgb_scale(:,1,2) - rgb(2)) <= i), find((rgb_scale(:,1,2) - rgb(2)) >= i));
    b_indices = intersect(find((rgb_scale(:,1,3) - rgb(3)) <= i), find((rgb_scale(:,1,3) - rgb(3)) >= i));
